...
(function(jQuery) {
    ...
    k.o = function () {
        ...
        this.jQuery = null; // jQuery wrapped element
        ...
        this.jQueryc = null; // jQuery canvas element
        ...
        this.run = function () {
            ...
            this.o = jQuery.extend(
                {
                    ...
                    // UI
                    cursor : (this.jQuery.data('cursor') === true && 30)
                                || this.jQuery.data('cursor')
                                || 0,
                    thickness : this.jQuery.data('thickness') || 0.35,
                    lineCap : this.jQuery.data('linecap') || 'butt',
                    ...
                    inputColor: this.jQuery.data('inputcolor') || this.jQuery.data('fgcolor') || '#87CEEB',
                    inline : false,
                    step : this.jQuery.data('step') || 1,
            ...
            if(this.jQuery.is('fieldset')) {
                ...
                this.jQuery.bind(
                    'change'
                    , function () {
                        s.val(s._validate(s.jQuery.val()));
                    }
                );
            }
            ...
            this.jQueryc = jQuery('<canvas width="' +
    ...
    k.Dial = function () {
        ...
        this.extend = function () {
            this.o = jQuery.extend(
                {
                    bgColor : this.jQuery.data('bgcolor') || '#EEEEEE',
            ...
            var s = this,
                mw = function (e) {
                            ...
                            var ori = e.originalEvent
                                ...
                                ,v = parseInt(s.jQuery.val()) + (deltaX>0 || deltaY>0 ? s.o.step : deltaX<0 || deltaY<0 ? -s.o.step : 0);
                ...
                .bind(
                    ...
                    ,function (e) {
                        if (isNaN(kval)) {
                            ...
                            // kval postcond
                            (s.jQuery.val() > s.o.max && s.jQuery.val(s.o.max))
                            || (s.jQuery.val() < s.o.min && s.jQuery.val(s.o.min));
                        }
